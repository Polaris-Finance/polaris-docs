...
The floor ratio frames only curve-implied downside in ETH terms, not the other risks listed above. For the full risk model, see [Risk Disclosure](https://tokenbrice.github.io/polaris-docs/resources/risk-disclosure).
