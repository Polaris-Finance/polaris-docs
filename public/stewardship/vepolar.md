...
vePOLAR cannot touch the immutable core. It cannot upgrade contracts, add admin keys, create gauges or bribe markets, or change user positions and balances by discretion. See [Stewardship](https://tokenbrice.github.io/polaris-docs/stewardship) for the full list.
