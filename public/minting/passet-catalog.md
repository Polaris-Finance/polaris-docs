...
> The pAsset debt tokens Polaris can issue (pUSD, pGOLD, pCHF, pBigMac), how pETH differs as collateral, and how StablecoinOS can add new assets.
...
**pUSD** | US dollar | **Testnet-active** | The flagship pAsset. See [Issuing pAssets](https://tokenbrice.github.io/polaris-docs/minting).
...
Next steps:
- [Open a Borrow Position](https://tokenbrice.github.io/polaris-docs/minting/open-a-trove): Issue your first pAsset against pETH collateral, step by step.
