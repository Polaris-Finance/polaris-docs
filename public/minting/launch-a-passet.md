...
> How external teams can launch a new pAsset on Polaris's shared pETH collateral base, and the requirements to qualify.
...
- [Fee Router & Flows](https://tokenbrice.github.io/polaris-docs/stewardship/fee-router): How revenue sharing for contracts building on Polaris works.
- [pETH & the Bonding Curve](https://tokenbrice.github.io/polaris-docs/peth): The shared collateral primitive every pAsset market uses.
