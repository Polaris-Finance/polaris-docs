...
POLAR is the utility token that supports liquidity, integrations, ecosystem incentives and long-term stewardship.
...
POLAR becomes active when it is committed as vePOLAR. Through vePOLAR, users can participate in stewardship decisions around flow recipients, ecosystem incentives, integrations, and other bounded parameters.
