...
POLAR is the utility token that provides the shared economic layer to support liquidity, integrations, ecosystem incentives and long-term stewardship. The primary reason to hold POLAR is to commit it as vePOLAR and receive protocol-native value from supported pAsset markets.
