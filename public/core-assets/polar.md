...
Around that foundation, liquidity [flows](https://docs.polaris.finance/architecture/flows) develop across different products, applications integrate the protocol, users build new strategies and the value generated throughout the Polaris ecosystem needs to be directed toward the participants who help it grow.
