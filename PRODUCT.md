...
- **Don't encode meaning in color alone** — token colors (USDp/pETH/POLAR) and status (done/now/forthcoming) must also read via label, shape, or text, for color-blind readers.
