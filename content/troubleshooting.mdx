...
If the wallet shows an unexpected spender, token, or amount, do not sign. Confirm the action, token, and contract against the app and [Contracts And Addresses](/resources/testnet#contracts-and-addresses).

## Quote Changed

Quotes can change as protocol state updates. Refresh the quote before signing.
