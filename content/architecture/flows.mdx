...
These incentive streams sit one layer above the [Fee Router](/design/fee-router), which first processes pETH-denominated protocol revenue through the bonding curve. Flows then determine where the resulting pETH rewards are sent.
