---
title: "Recovery Mode"
description: "Recovery Mode is the protective state a pAsset market enters when its backing falls below full collateralization."
---

# Recovery Mode

Recovery Mode is the protective state a [pAsset market](/architecture/passet-markets) enters when its **reserve-to-debt ratio falls below 100%**, meaning the collateral in the market no longer fully covers its outstanding debt.
...
A market leaves Recovery Mode when its backing rises back above full collateralization. Once backing recovers past the [Defensive Mode](/design/defensive-mode) threshold, the market returns to normal operation.
...
**Note:** Recovery Mode is a feature of individual pAsset markets. It does not affect the [bonding curve](/architecture/bonding-curve), which continues to function normally regardless of the state of any pAsset market.
