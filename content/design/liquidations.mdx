...
This liquidation mechanism is one source of protocol-native yield distributed to Earn Vault depositors and is explained in greater detail in the dedicated [Earn Vaults](/architecture/earn-vaults) section.
