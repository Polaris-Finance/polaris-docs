...
<Figure
  src="/infographics/rising-floor-mechanism.svg"
  alt="The rising pETH floor as a staircase stepping up over time, each step driven by swap-fee burns, conversion-auction burns, or other pETH-denominated fee burns"
  width={1200}
  height={700}
/>
...
<Figure
  src="/infographics/floor-ratio-explainer.svg"
  alt="A volatile pETH market-price line above a steadily rising floor line, showing the floor ratio as the distance between them"
  width={1200}
  height={700}
/>
