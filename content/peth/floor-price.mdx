...
Current testnet values live in [Parameters](/resources/testnet#parameters). Public Testnet 1 values are testnet-only. Production values should not be inferred until they are published in Launch Status and Parameters.
