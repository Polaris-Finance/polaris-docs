...
## Related App Tabs
- [Split](/using-app/split): Split pETH into fpETH and vpETH, or merge both legs back into pETH.
- [Issue](/using-app/issue): Create pAssets and access reserve-loan actions if supported in the app.
- [Dashboard](/using-app): View live token prices, balances, and position state.
## Next Steps
- [pETH Floor Price](/peth/floor-price): Understand the floor that backs fpETH.
- [Issue](/using-app/issue): Use pETH to create pAssets.
