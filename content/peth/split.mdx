...
description: "How pETH splits into fpETH and vpETH, what each token represents, how merging works, and how reserve loans use fpETH."
---
...
## Next Steps
- [pETH Floor Price](/peth/floor-price): Understand the floor that backs fpETH.
- [Open a Position](/minting/open-a-trove): Use pETH to create pAssets.
- [Risk Disclosure](/resources/risk-disclosure): Understand the risks around pETH, fpETH, vpETH, and reserve loans.
