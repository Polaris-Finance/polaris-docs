...
This page is the single source for Public Testnet 1: [environment](#environment), [manifest sources](#manifest-sources), [parameters](#parameters), [contract addresses](#contracts-and-addresses), and [verification](#verification).

<Callout variant="warning" title="Testnet values, not production">
Everything below is Public Testnet 1 on Sepolia, last verified June 8, 2026. Sepolia values are replaceable artifacts with no monetary value, no production redemption, and no mainnet claim — do not infer production constants or addresses from them. Production values are not published unless this page and <a href="/launch-status">Launch Status</a> say they are.
</Callout>
...
| pGOLD testnet price feed | [`0x8a891736218fb98cabf23b39e4b8f6f2876011f4`](https://sepolia.etherscan.io/address/0x8a891736218fb98cabf23b39e4b8f6f2876011f4) |
...
3. Open `https://sepolia.etherscan.io/address/<address>` and match the address exactly; confirm the source or ABI matches the verified explorer entry when verification is published.
