...
Current status:
Fee Router addresses, ABIs, events, distribution cadence, Flow whitelists, and final parameter bounds are pending audited deployment. Use [Contracts And Addresses](/resources/testnet#contracts-and-addresses) and [Parameters](/resources/testnet#parameters) for published values.
