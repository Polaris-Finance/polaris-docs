...
- Confirm the frontend, network, and wallet prompts against [Safety & Verification](/resources/safety-verification). Use test assets only — see [Public Testnet 1 Artifacts](/resources/testnet).
