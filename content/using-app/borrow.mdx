...
The simulator uses the current Public Testnet 1 MCR of 115% (about 87.0% max LTV); verify live values on [Parameters](/resources/testnet#parameters) and in the app before signing. See [Managing Your Trove](/minting/managing-your-trove) for how LTV drifts after you open.
