...
Pendle separates a yield-bearing asset into fixed and variable yield exposure, while Polaris keeps the yield mechanism unchanged and instead separates pETH into its steadily growing floor and the market premium above it.

| Protocol | Separates the yield-bearing asset into |
| --- | --- |
| Pendle | Fixed yield exposure + variable yield exposure |
