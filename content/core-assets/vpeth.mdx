...
After the premium hedge, the remaining ETH/USD exposure can be hedged on an external venue to make the combined position delta-neutral with respect to ETH/USD while preserving exposure to growth in the pETH floor.

Because the position and hedge values can change, maintaining neutrality may require rebalancing, while the strategy remains exposed to funding, basis, liquidation, liquidity, oracle and smart contract risk.
