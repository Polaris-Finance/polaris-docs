...
Final supply, distribution, vesting, vePOLAR deployment details, and production parameters are pending. Launch materials, [Launch Status](/launch-status), and [Parameters](/resources/testnet#parameters) own final numbers.
For the reasoning behind the token, see [POLAR](/polar). For the issuance mechanism, see [Conversion Auctions](/polar/conversion-auctions).
## Issuance Structure
