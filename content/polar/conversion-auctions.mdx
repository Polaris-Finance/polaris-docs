...
On Public Testnet 1, conversions are Sepolia-only where exposed. Production conversions are not actionable until [Launch Status](/launch-status) publishes the official app, contracts, final parameters, and audit status.
