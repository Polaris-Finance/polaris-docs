---
title: "Risks"
description: "Polaris is built as immutable onchain infrastructure."
---
...
Polaris uses a Medianizer to reduce reliance on a single oracle source where multiple feeds are available, but oracle risk cannot be fully removed.
...
- Avoid unofficial links or support channels
