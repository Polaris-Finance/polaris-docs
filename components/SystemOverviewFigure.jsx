  ...
  return (
    <figure className="pl-system-overview">
      <img
        ...
        alt="Polaris system overview: ETH swaps into pETH on the bonding curve, pETH collateralizes pAsset branches that issue USDp, and burning pETH for POLAR raises the floor and releases ETH"
        width={1200}
        height={540}
        loading="lazy"
        decoding="async"
